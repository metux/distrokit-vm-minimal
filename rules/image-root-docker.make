...
IMAGE_ROOT_DOCKER_LABEL	:= $(shell echo "$(IMAGE_ROOT_DOCKER_LABEL)" | tr '[:upper:]' '[:lower:]')
IMAGE_ROOT_DOCKER_MSG	:= $(call remove_quotes, $(PTXCONF_IMAGE_ROOT_DOCKER_MESSAGE))
...
$(IMAGE_ROOT_DOCKER_IMAGE):
	...
	@$(PTXCONF_IMAGE_ROOT_DOCKER_CMD) import --message="$(IMAGE_ROOT_DOCKER_MSG)" $(IMAGE_ROOT_DOCKER_IMAGE) "$(IMAGE_ROOT_DOCKER_LABEL)"
	@$(call finish)
endif
